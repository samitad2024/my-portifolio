...
class AboutMeSection extends StatelessComponent {
      ...
      div(classes: 'about-section-body', [
        ...
        div(classes: 'about-details', [
          ...
          span(
            ...
            styles: Styles.text(color: Colors.lightGrey),
  ...
  static final List<StyleRule> styles = [
    ...
    css('.profile-picture')
        .background(
          image: ImageStyle.url(StaticAssets.coloredImage),
    ...
    css('.about-details')
        ...
        .box(width: 750.px),
    css('.intro-label', [css.text(fontSize: 18.px)]),
    css('.intro-heading', [
      css.box(margin: EdgeInsets.symmetric(vertical: 15.px)),
      css.text(fontSize: 20.px),
    ]),
    css('.intro-details', [
      css.text(lineHeight: 3.vh, wordSpacing: 1.5.px, color: Colors.lightGrey),
    ]),
    css('.divider')
        .box(
          height: 1.px,
    ...
    css('.tech-label', [css.text(fontSize: 12.px)]),
    css('.tech-stack')
        .flexbox(
          direction: FlexDirection.row,
          alignItems: AlignItems.center,
        ...
        .box(margin: EdgeInsets.only(top: 15.px)),
    css('.tech-item', [
      css.box(
        margin: EdgeInsets.only(right: 12.px, left: 5.px),
      ),
      css.text(fontSize: 14.px),
    ]),
    css('.personal-label', [
      css.text(fontWeight: FontWeight.bold, fontSize: 12.px),
    ]),
    css('.personal-value', [css.text(fontSize: 12.px)]),
    css('.personal-row')
    ...
    css.media(MediaQuery.screen(maxWidth: 900.px), [
      ...
      css('.profile-picture')
          ...
          .box(width: 250.px, height: 250.px),
