...
final defaultJasprOptions = JasprOptions(
  clients: {
    ...
    prefix0.AppButton: ClientTarget<prefix0.AppButton>(
      'components/app_button',
      params: _prefix0AppButton,
    ),
    prefix1.ContactCard: ClientTarget<prefix1.ContactCard>(
      'components/contact',
      params: _prefix1ContactCard,
    ),
    ...
    prefix4.ProjectCard: ClientTarget<prefix4.ProjectCard>(
      'components/project_card',
      params: _prefix4ProjectCard,
    ),
    prefix5.ServiceCard: ClientTarget<prefix5.ServiceCard>(
      'components/service_card',
      params: _prefix5ServiceCard,
    ),
    prefix7.AboutMeSection: ClientTarget<prefix7.AboutMeSection>(
      'sections/about_me',
      params: _prefix7AboutMeSection,
    ),
  },
  styles: () => [
...
Map<String, dynamic> _prefix5ServiceCard(prefix5.ServiceCard c) => {
  'icon': c.icon,
  'label': c.label,
};
Map<String, dynamic> _prefix7AboutMeSection(prefix7.AboutMeSection c) => {
  'about': c.about,
  'basic': c.basic,
};
