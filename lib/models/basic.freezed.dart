...
mixin _$Basic {
  ...
  int get hashCode => Object.hash(runtimeType, firstName, lastName, age, email,
      phone, address, const DeepCollectionEquality().hash(photos), resume);
...
extension BasicPatterns on Basic {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Basic value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String firstName, String lastName, int age, String email,
            String phone, String address, List<String> photos, String resume)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Basic() when $default != null:
        return $default(_that.firstName, _that.lastName, _that.age, _that.email,
            _that.phone, _that.address, _that.photos, _that.resume);
      case _:
        return orElse();
    }
  }
